...
const Store = ({ navigation }) => {
  ...
  const [products, setProducts] = useState([
    {
      id: "78FEjgiyvBTp3D5DpYam",
      image: "gs://pet-tracker-65ea5.appspot.com/cat_cloth1.jpg",
      name: "고양이용 니트 스웨터",
      description: "고양이를 위한 니트 스웨터",
      price: '20,000원',
    },
    {
      id: "iUO3z8wDDvsQZMGboeOJ",
      image: 'https://example.com/image2.jpg',
      name: '반려견용 배변 패드',
      description: '반려견을 위한 배변 패드',
      price: '12,000원',
    },
    {
      id: "oFV4NJHHFyMTS1gmSfYy",
      image: 'https://example.com/image1.jpg',
      name: '고양이 장난감 레이저 포인터',
      description: '고양이를 위한 레이저 포인터',
      price: '10,000원',
    },
  ]);
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity
      ...
      onPress={() => {
        console.log("Navigating to ProductDetails with id:", item.id); // 로그 추가
        navigation.navigate('ProductDetails', { id: item.id }); // id만 전달
      }}
    >
  ...
  <SvgXml xml={svgString2} width="28" height="28" style={styles.icon} />
      ...
      <View style={styles.filterContainer}>
        <TouchableOpacity
          ...
          onPress={() => setSelectedFilter('앱 내 용품')}
        >
