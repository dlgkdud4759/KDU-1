...
const Login = ({ navigation }) => {
    ...
    try {
      ...
      if (userSnapshot.exists()) {
        ...
        if (userData.isInfoCompleted === true) { // true로 비교
          navigation.navigate("Main"); // 정보 입력 완료 시 main 화면으로 이동
        } else {
          navigation.navigate("Information"); // 정보 입력 미완료 시 정보 입력 화면으로 이동
        }
      } else {
  ...
  return (
    <View style={styles.login}>
      ...
      <TouchableOpacity style={styles.signUpButton} onPress={() => navigation.navigate("Membership")}>
